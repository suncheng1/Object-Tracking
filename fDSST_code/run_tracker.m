...
% base_path = 'sequences/';
base_path = 'G:\trackingDatabase\OTB100\OTB100/';
...
params.interp_factor = 0.025;			% 学习率，tracking model learning rate (denoted "eta" in the paper)
params.num_compressed_dim = 18;         % the dimensionality of the compressed features
params.refinement_iterations = 1;       % 精确确定目标中心时的最大迭代次数，number of iterations used to refine the resulting position in a frame
params.translation_model_max_area = inf;% maximum area of the translation model    inf：正无穷大
...
% calculate precisions     ground_truth，positions与DSST中行列相反
